...
//
//			STEP 3: Get explosion_shader.fx in the project directory, and if you include it into the project, then properties: no built
//
//			STEP 4: in the initdevice() function, initialize the explosion handler:
//				explosionhandler.init(g_pd3dDevice, g_pImmediateContext);
//
//			STEP 5: also in the init device, you can initialize the different explosions
...
//
//			STEP 6: in the render function, write this at the end BEFORE the swapchain->present() method:
//				g_pImmediateContext->OMSetDepthStencilState(ds_off, 1);
//				explosionhandler.render(&view, &g_Projection, elapsed);
//				g_pImmediateContext->IASetInputLayout(g_pVertexLayout);
//				g_pImmediateContext->OMSetDepthStencilState(ds_on, 1);
//
//			STEP 7: make new explosions with
